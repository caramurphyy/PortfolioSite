...
import wave1 from '@/assets/backgrounds/wave1.svg'
import wave2 from '@/assets/backgrounds/wave2.svg'
import wave3 from '@/assets/backgrounds/wave3.svg'
import wave4 from '@/assets/backgrounds/wave4.svg'
import wave5 from '@/assets/backgrounds/wave5.svg'
...
const artworks = [
  { id: 1, src: RainierPainting, alt: 'Rainier Painting', title: 'Commute Kairos', year: '2026', description: 'Everyday I would ride the bus home in Seattle in the fall, when sunset is perfectly around 5-6 pm, and look forward to the opportunity of sighting Mount Rainier as we crossed the Evergreen Point Bridge. Often, it was too cloudy, but I always made sure to sit on the left side of the bus and watch. This is my largest painting, a 30x40"', medium: 'Acrylic' },
  { id: 2, src: GouDanJan2026, alt: 'Gou Dan Jan 2026', title: 'Shoveling Companion', year: '2026', description: 'On cold dark mornings when clearing freshly fallen snow, it sure is nice to have a companion who does\'nt appear to feel the cold at all.', medium: 'Acrylic' },
  ...
  { id: 7, src: GouDan, alt: 'Gou Dan', title: 'Pretty in Pink', year: '2025', description: 'My mom requested a painting to match the pink shower curtain in the bathroom, now everytime I pull back the curtain I smile at the joyful dog that appears on the wall.', medium: 'Acrylic' },
  ...
  { id: 10, src: Nightstand, alt: 'Nightstand', title: 'Nighstand', year: '2024', description: 'In Fall 2024 I finally took an art class. This assignment was to paint a scene with one color, I chose blue and my nightstand which featured jewelry, a mini globe, and a candle.', medium: 'Acrylic' },
  { id: 11, src: MAMSMural, alt: 'Colorful Mural with 4 distinct sections with different students doing activities in each displayed on the wall of the Massachusetts Academy of Math and Science Library', title: 'MAMS Mural', year: '2022', description: 'One day in high school I proposed the idea of painting a mural to my advisor, he immediatelty got up and started looking for a spot on the school\'s walls for it, that was pretty awsome.', medium: 'Acrylic' },
  ...
  { id: 13, src: ChristmasFromLivingRoom, alt: 'Christmas From Living Room', title: 'Chinese Living Room', year: '2025', description: 'This is a duplicate image of the painting but from a different view.', medium: 'Acrylic' },
  { id: 14, src: MiffyLandscape, alt: 'Miffy Landscape', title: 'Tiny Miffy', year: '2024', description: 'A tiny scene of miffy as a birthday gift for a friend when I was too sick to visit.', medium: 'Acrylic' },
  { id: 15, src: HigginsHouse, alt: 'Higgins House', title: 'Higgins House', year: '2021', description: 'A snowy day on the WPI campus at my favorite spot, the higgins house arches.', medium: 'Gouache' },
  { id: 16, src: Flute, alt: 'Flute', title: 'Flautist', year: '2021', description: 'A gift for my flute teacher of many years', medium: 'Acrylic' },
  { id: 17, src: Christmas2024, alt: 'Christmas 2024', title: 'Chinese Living Room ', year: '2025', description: 'My mom requested a painting that matched our living room, a room with blue couches, warm golden light, small red flowers in china vases atop oak wood tables, and enormous floor to ceiling scrolls of chinese characters on the walls.', medium: 'Acrylic' },
  { id: 18, src: GouacheGirls, alt: 'Gouache Girls', title: '', year: '', description: '', medium: 'Gouache' },
]

function App() {
  return (
    <div className="relative w-full bg-[#EAE0CC]">
      {/* Stacked wave backgrounds - starts midway through intro */}
      <div className="absolute top-16 md:top-10 lg:top-0 xl:top-[-50px] left-0 right-0 w-full pointer-events-none origin-top scale-y-[2] min-[650px]:scale-y-150">
      ...
      <div className="relative z-10 w-full">
        ...
        <div className="columns-2 md:columns-3 gap-2 md:gap-4 px-5 lg:px-10 [&>*]:mb-2 md:[&>*]:mb-4 [&>*]:break-inside-avoid">
          {artworks.map((art) => (
            <Art
              key={art.id}
              src={art.src}
        ...
        <div className="px-5 lg:px-10 py-10">
          <p className="text-center max-w-3xl mx-auto mb-8 font-[system-ui,Avenir,Helvetica,Arial,sans-serif] text-sm md:text-base text-black md:text-white">
