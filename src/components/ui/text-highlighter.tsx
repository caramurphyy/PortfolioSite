  ...
  const renderHighlight = () => {
    ...
    if (type === 'zigzag') {
      ...
      return (
        <svg
          className="absolute pointer-events-none"
          style={{ ...svgStyle, bottom: `-${svgHeight * 0.2}px`, width: `${svgWidth}px`, height: `${svgHeight}px` }}
          viewBox={`0 0 ${svgWidth} ${svgHeight}`}
          preserveAspectRatio="none"
        >
          <motion.path
