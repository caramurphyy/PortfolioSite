...
const buttonVariants = cva(
  "relative inline-flex items-center justify-center gap-2 font-semibold text-base transition-all outline-none border-none hover:border-none focus:outline-none focus-visible:outline-none focus-visible:ring-0 disabled:pointer-events-none disabled:opacity-50 overflow-hidden [&_svg]:pointer-events-none",
  {
    variants: {
      variant: {
...
const variantColors: Record<
  ...
  VariantColorsType
> = {
  default: { fromBg: "#EC573F", toBg: "#F28D7D", stroke: "#F28D7D" },
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative z-20 inline-flex items-center text-white"
          )}
        >
